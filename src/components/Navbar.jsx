...
import myWhiteLogo from '../../public/assets/logowhiteNoBackground.png';
  ...
  return (
    ...
    >
      <div className="flex justify-between   items-center w-full h-full px-2 2xl:px-16">
        <Link href="/">
          <Image src={myWhiteLogo} alt="/" width="145" height="50" />
        </Link>
        <div>
          ...
          <div>
            <div className="flex w-full items-center justify-between">
              <Link href="/" onClick={handleNav}>
                <Image src={myWhiteLogo} alt="/" width="120" height="50" />
              </Link>
              <div
                onClick={handleNav}
          ...
          <div className="py-4 flex flex-col">
            <ul className="uppercase">
              ...
              <Link href="/#blog" onClick={handleNav}>
                <li className="py-4 text-sm">Artigos</li>
              </Link>
